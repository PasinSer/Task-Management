  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
       ...
       "รอดำเนินการ-gradient" : "linear-gradient(90deg, rgba(244,127,249,1) 0%, rgba(99,0,146,1) 100%)",
       "เสร็จสิ้น-gradient" : "linear-gradient(90deg, rgba(127,144,249,1) 0%, rgba(7,16,191,1) 100%)"
      },
