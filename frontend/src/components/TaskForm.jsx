...
function TaskForm() {
  ...
  useEffect(() => {
    setTaskDetails({
      ...
      status: currentTask?.status ?? "สิ่งที่ต้องดำเนินการ",
    });
          ...
          >
            ...
            <select
              ...
              className={`status-select w-24 outline-none border-0 ${
                taskDetails?.status === "สิ่งที่ต้องดำเนินการ"
                  ? "bg-yellow-200"
                  : taskDetails.status === "รอดำเนินการ"
                  ? "bg-pink-200"
                  : "bg-blue-200"
            ...
            >
              <option value="สิ่งที่ต้องดำเนินการ" className="bg-white">
                สิ่งที่ต้องดำเนินการ
              </option>
              <option
                value="รอดำเนินการ"
                className="bg-white"
                selected={currentTask?.status === "รอดำเนินการ" ? true : false}
              >
                รอดำเนินการ
              </option>
              <option
                value="เสร็จสิ้น"
                className="bg-white"
                selected={currentTask?.status === "เสร็จสิ้น" ? true : false}
              >
                เสร็จสิ้น
              </option>
            </select>
          ...
          >
            ...
            >
              ...
              <option
                value="medium"
                className="bg-white"
                selected={currentTask?.priority === "ปานกลาง" ? true : false}
              >
                ปานกลาง
              </option>
              <option
                value="high"
                className="bg-white"
                selected={currentTask?.priority === "สูง" ? true : false}
              >
                สูง
              </option>
            </select>
